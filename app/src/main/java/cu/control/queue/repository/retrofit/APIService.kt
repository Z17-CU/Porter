...
interface APIService {
    ...
    @GET
    fun getQueue(@Url url: String = GET_QUEUE_PORTER_URL, @HeaderMap headers : Map<String, String>): Call<Queue>

    @PUT
    fun putCollaborator(@Url url: String = COLABORATOR_PORTER_URL, @HeaderMap headers : Map<String, String>): Call<String>

    @DELETE
    fun deleteCollaborator(@Url url: String = COLABORATOR_PORTER_URL, @HeaderMap headers : Map<String, String>): Call<String>
