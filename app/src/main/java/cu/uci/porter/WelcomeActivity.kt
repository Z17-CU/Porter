...
import cu.uci.porter.utils.PreferencesManager
...
class WelcomeActivity : AppIntro2() {
    ...
    private fun showIntroSlides() {
        val pageOne = SliderPagerBuilder()
            ...
            .descColor(ContextCompat.getColor(this, R.color.colorPrimary))
            .description(getString(R.string.first_description))
            .imageDrawable(R.drawable.ic_recurso_1)
            .bgColor(ContextCompat.getColor(this, R.color.colorIntroBG))
            .build()
